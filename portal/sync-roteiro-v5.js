...
const items = [
    ...
    },
    {
        ...
        tags: ['Kruger', 'Base'],
        details: { tips: 'Hospedagem Confirmada (Agoda ID: 976704298). Pago via Wise. Use a rota S100 perto de Satara para as melhores chances de ver felinos.' },
        content: 'Hospedagem prática e moderna colada ao portão de Orpen. Ideal p/ safári intenso.'
    },
    // --- Day 9-10 ---
    {
        slug: 'ngwenya-glass',
