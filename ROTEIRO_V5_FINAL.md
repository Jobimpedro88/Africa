w# 🇿🇦 ROTEIRO V5 FINAL: "THE SMART ROUTE" (24 Dias)
**Viajantes:** Jobim & Paulinha
**Data:** 11 de Março a 03 de Abril de 2026
**Status:** ✈️ Voos Comprados | 🏨 Mdluli Confirmado | ⏳ Reservando Hoteis/Carros
...
## 💡 DICAS DE OURO (Carol & Elena)
*   **Dinheiro:** Saque **ZAR 2.000** no aeroporto para pedágios (Tolls) e gorjetas (Car Guards/Frentistas). O resto é cartão (Wise/Nomad).
*   **Carro:** Use o **Visa Infinite/Mastercard Black** para pedir Status Match na **Avis** ou **Sixt** (Platinum). Isso garante upgrade de categoria e fila prioritária no balcão. Faça isso online antes de viajar!
*   **Table Mountain & Robben Island (Dica da Dani):** Faça nos **primeiros dias**! Eles cancelam na hora sem aviso por causa do vento (é fácil remarcar/reembolsar). Na Table Mountain, vá cedo, o bondinho costuma fechar perto do pôr do sol. A regra é clara: **Acordou e tem sol? SUBIA.**
*   **🚨 Segurança em Trilhas (CT):** A Dani (moradora) alerta: **NÃO** é aconselhável fazer *hiking* na Table Mountain nem na Lion's Head no momento. Ocorreram muitos assaltos nos últimos meses. Opte sempre pelo bondinho.
*   **Segurança em Joanesburgo:** Fique na bolha de **Sandton/Mandela Square** ou **Rosebank**. Não ande a pé à noite fora dessas áreas.
*   **Carro no Kruger:** Algumas locadoras cobram taxa extra de limpeza pesada se o carro tiver ido para estradas de terra no parque. Prepare-se.
*   **Salas VIP:** [Ver Guia Completo de Salas VIP e Mapas](guia_salas_vip.md) - Estratégia para comer e beber de graça nos aeroportos.
*   **Restaurantes (Timing de Reserva):** 
    *   **Marble (JNB):** Abre **60 dias** antes via [Dineplan](https://www.dineplan.com/restaurants/marble-johannesburg).
    *   **The Pot Luck Club (CPT):** Abre **4 meses** antes via [Dineplan](https://www.dineplan.com/restaurants/the-pot-luck-club-cape-town). Reserva essencial!
    *   **Babel (Babylonstoren):** Online abre **9 meses** antes; hóspedes podem tentar via concierge com **2 meses**.

---

## 📅 LEG 1: A CHEGADA & PANORAMA (11 - 15 Mar)

### **11/03 (Quarta): Brasil -> África**
*   **Voo Ida:** Latam (BSB -> GRU -> JNB).
    *   **15:00:** BSB -> GRU (LA3528).
        *   **🥂 Sala VIP BSB:** Use a **Aeroportos VIP Club** (Doméstica). Fica no 2º andar depois do raio-x. É enorme e tem chuveiros.
    *   **22:45:** GRU -> JNB (LA8058).
        *   **🥂 Sala VIP GRU (T3):** Voo sai do T3. Melhores opções: **Espaço Banco Safra** ou **W Premium Pier** (perto do portão). Mastercard Black no térreo vive lotada.

### **12/03 (Quinta): Pouso & Dullstroom**
### **12/03 (Quinta): Pouso & Dullstroom**
*   **12:40:** Chegada em JNB (O.R. Tambo).
*   **15:00:** Saída do Aeroporto (após imigração/carro).
*   **17:30:** Chegada em **Dullstroom**. 
    *   **Dica do Agente:** Pousar e ir direto para Dullstroom é a escolha mais segura. Dirigir além disso (Lydenburg/Graskop) obrigaria você a dirigir à noite em estradas com neblina e buracos (*potholes*). Dullstroom é a "bolha" perfeita para o primeiro dia.
*   **14:00: Retirada Carro 1 - [GreenMotion](https://greenmotion.com/) (Meet & Greet)**
    ...
    *   **Dica:** Tire fotos de todos os arranhões no carro antes de sair.
    *   **Pagamento Final:** £120.40 (aprox. ZAR 2.800). Cartão físico obrigatório.
...
*   **Hospedagem (Confirmada):**
    *   **🥇 Cinzaco Accommodation**
        *   **Onde reservamos:** Hoteis.com (Reserva: 72071373414521).
        *   **Política de cancelamento:** Grátis até 24 de fev, 2026. (50% após essa data).
        *   **Cartão utilizado:** Visa (final 0702).
        *   **Valores financeiros:** Já pago: R$ 353,49. A pagar no hotel: R$ 0,00.
        *   **Benefícios:** Cashback 8% Banco Inter. Hoteis.com (1 selo).
        *   **Forma de pagamento:** Parcelado em 12x sem juros.
        *   **Contatos e Mídia:** 
            *   Endereço: 186 De Waal Street, Dullstroom. (Recepção: 7h-10h, avise se chegar após 19h).
            *   Mídia/Maps: [Localização no Google Maps](https://www.google.com/maps/search/Cinzaco+Accommodation+Dullstroom) | [Vídeos YouTube](https://www.youtube.com/results?search_query=Cinzaco+Accommodation+Dullstroom).
    *   **❌ The Highlander:** Esgotado. | **❌ Walkersons:** Afastado e caro para apenas uma noite de descanso.
*   **Jantar em Dullstroom (Reservar!):**
    1.  **Mrs Simpson's:** [Menu & Info](https://mrssimpsons.co.za/).
        *   *O que pedir:* **Dullstroom Trout** (Truta recheada com amêndoas) ou **Lamb Shank** (Cordeiro). De sobremesa: Sorvete de Manteiga de Amendoim.
    2.  **The Mayfly:** [Menu & Info](https://mayfly.co.za/). Alternativa mais casual.
        *   *O que pedir:* **Trout & Feta Salad** ou o **Pork Ribs**. Tem lareira, ambiente aconchegante.
    3.  **Harrie's Pancakes:** Só abre até as 17h, mas vale para um café da tarde se chegar cedo.

### 13/03 (Sexta): A Janela de Deus & Cachoeiras (Detalhado)

**Resumo da Rota:** Dullstroom -> Sabie -> Mac Mac Falls -> Graskop -> Angels View.
**Tempo Total de Estrada:** ~2h 30min (sem contar paradas).
**Estrada:** R532 (Asfalto bom, mas com curvas na serra. Cuidado com neblina).

#### **09:00 - Saída de Dullstroom**
*   **Destino:** Sabie (via R37 e R532).
*   **Tempo:** 1h 40min (110km).
*   **Cenário:** A estrada sobe a montanha (Long Tom Pass). Vista incrível.

#### **11:00 - Parada 1: Mac Mac Falls** 💦
*   **Onde Fica:** Na R532, 13km depois de passar por Sabie (direção Graskop).
*   **Google Maps:** [Localização Mac Mac Falls](https://www.google.com/maps/search/?api=1&query=Mac+Mac+Falls+Sabie)
*   **Entrada:** **ZAR 50** por pessoa (Leve dinheiro vivo/cash, a máquina nem sempre funciona).
*   **A Experiência:**
    *   Do estacionamento (cheio de vendedores de artesanato), você caminha uns 10-15 minutos por uma trilha cimentada e segura (com grades).
    *   Chega-se a um mirante suspenso ("The Cage") bem de frente para a queda dupla de 65 metros.
    *   *Dica de Foto:* Tente pegar o arco-íris que se forma na base.
*   **Vídeo:** [Mac Mac Falls](https://www.youtube.com/watch?v=1ky-eXMUS90)
*   **Horário:** 08h00 - 17h00 | **Dica:** Desça até a plataforma de observação. Tenha moedas (ZAR 50) para a entrada.

#### **12:30 - Almoço em Graskop**
*   **Estrada:** +15 min (20km) até a cidade de Graskop.
*   **Sugestões (O que pedir):** 
    *   **The Glass House:** O segredo local para comida caseira excepcional. Sugestão: o famoso *Filet Steak* (muito macio), o autêntico *Bobotie* ou o *Oxtail*. As taças de vinho da casa são muito bem servidas. Reserva é indispensável.
    *   **Harrie's Pancakes:** A parada turística clássica. *Salgadas:* Panqueca de Bobotie com Chutney ou Thai-Style Chicken. *Doces:* Clássica Cinnamon Sugar ou Dark Chocolate com Merengue e Coco.

#### **14:00 - Parada 2: Graskop Gorge Lift** 🌲
*   **Onde Fica:** Logo na saída da cidade (R533).
*   **Google Maps:** [Localização Graskop Gorge](https://www.google.com/maps/search/?api=1&query=Graskop+Gorge+Lift+Company)
*   **Entrada (2025):**
    *   Apenas Entrada: R75.
    *   **Lift Experience (Elevador + Floresta):** **R205** (Recomendado).
*   **A Experiência:**
    *   Você desce 51 metros num elevador de vidro até o fundo do cânion.
    *   Lá embaixo, tem uma trilha suspensa de madeira (600m) no meio da floresta nativa. É fresco, úmido e lindo.
    *   Para os corajosos: Tem o **Big Swing** (Balanço gigante).
*   **Vídeo:** [Graskop Gorge Lift Experience](https://www.youtube.com/watch?v=4vk46x1weMI)
*   **Horário:** 08h30 - 17h00 | **Dica:** Caminhe pela trilha suspensa de madeira lá embaixo na floresta. Muito bem estruturado.

#### **16:30 - Check-in: Hospedagem Confirmada (Angels View)**
*   **Datas da Estadia:** 13/03 a 15/03 (2 noites).
*   **🥇 Angels View Hotel**
    *   **Onde reservamos:** Agoda (Reserva: 970229974).
    *   **Política de cancelamento:** Não reembolsável.
    *   **Cartão utilizado:** Wise (final 4307).
    *   **Valores financeiros:** Já pago: USD 316,77 (aprox. R$ 1.800). A pagar no hotel: R$ 0,00.
    *   **Benefícios:** Cashback de USD 150 no Capital One Shopping (Lembrete: conferir se foi processado).
...
## 🦁 LEG 2: O SAFÁRI (15 - 19 Mar) - Guia Definitivo

**⚠️ ALERTA DE SEGURANÇA (CRÍTICO):**
*   **Portão de Entrada:** O GPS vai mandar você pelo **Numbi Gate**. **IGNORE completamente.**
*   **A Rota Segura (Phabeni Gate):** Dirija até Hazyview e entre pelo **PHABENI GATE**, que tem uma estrada de acesso perfeitamente segura. A estrada do Numbi tem histórico de assaltos a turistas.

A estratégia aqui é um mix inteligente: 2 noites de Glamour/Luxo (Mdluli) seguidas de 2 noites focadas em Safári Econômico e Autônomo na melhor região de felinos (Orpen/Satara).
...
*   **13:00 - 15:00:** O trajeto do portão até o lodge já é um *Self-Drive Safari* (~50km). Vá no limite de velocidade do parque (50km/h no asfalto, 40km/h na terra).
    *   **🚨 Regras de Ouro Self-Drive (Dica da Dani):** Pode dar frio na barriga, mas siga as regras: **NUNCA** saia do carro; mantenha tanque cheio (pois o celular fica sem sinal e reboque demora); não pare perto demais dos animais selvagens; e calcule rotas sempre com muita folga de tempo.
*   **15:00 - Check-in: Hospedagem Confirmada (Kruger Park)**
    *   **🥇 Mdluli Safari Lodge (Barraca Superluxo)**
        *   **Onde reservamos:** Hoteis.com (Reserva: 72071022668342).
        *   **Política de cancelamento:** Selecionado Não Reembolsável.
        *   **Cartão utilizado:** Visa (final 4901).
        *   **Valores financeiros:** Já pago: R$ 4.049,83. A pagar no hotel: R$ 69,10 (Taxas de destino).
        *   **Benefícios:** Cashback Banco Inter (% a confirmar) + 1 Selo (Noite de recompensa) resgatado (-R$ 503,51).
...
### **16/03 (Segunda): O Dia Híbrido no Mdluli**
*   **06:00 - 09:00 (Atividade Sugerida):** **Early Morning Game Drive** guiado (ZAR 1.170 por pessoa). A rádio dos *rangers* rastreia ativamente os Big 5 no nascer do sol.
*   **09:30:** Café da manhã delicioso e farto no lodge.
*   **11:00 - 15:00: Tempo Livre & Epicurean.**
    *   *Opção 1:* Curtir a piscina de borda infinita com vista para a barragem (é comum ver elefantes bebendo água).
    *   *Opção 2:* Contratar o exclusivo **Picnic on the granite rock** (ZAR 725 para duas pessoas) – um piquenique privado e panorâmico nas rochas dentro do lodge. Um *highlight* do *AI Travel Manifesto*.
*   **15:30 - 18:00:** Saia com seu carro de aluguel (*Self-Drive* Gratuito) em direção ao Skukuza Rest Camp (para um café na beira do rio) ou contorne a estrada de terra H1-1 próxima para avistamentos privativos.
*   **19:00:** Jantar no lodge (Incluído).

### **17/03 (Terça): Transição para o Norte ("Cat Camp")**
*   **08:00:** Café da manhã seguido de Check-out do Mdluli Safari Lodge.
*   **09:30:** Saída. O trajeto hoje não é estressante, pois a estrada em si **é** o safári. Começaremos a dirigir do sul (Pretoriuskop/Skukuza) em direção ao norte (Satara/Orpen), cerca de 2h30 a 3h contínuas (110km a 40km/h), imersos na savana profunda.
*   **12:30:** Parada estratégica e almoço no icônico **Tshokwane Picnic Site**. 
    *   *Dica do Especialista:* Vá direto na lojinha e peça as tradicionais "Wild Game Pies" (Empanadas/Tortas de carne de caça), famosas como a melhor comida rápida do parque.
*   **14:30 - 17:00:** Foco total em safári na região de Satara (Rotas S100 ou H7). Essa área central do parque tem grama baixa e uma alta densidade de pastadores (zebras/gnus), o que atrai, inevitavelmente, os grandes felinos. É a terra dos leões.
*   **17:30 - Check-in: [SleepOver Orpen Gate](https://sleepover-motels.co.za/orpen-gate/)**
    *   **Datas da Estadia:** 17/03 a 19/03 (2 noites).
    *   **Localização:** Literamente colado no Orpen Gate (Entrada Centro-Oeste do Parque).
    *   **Por que:** Mudança inteligente para a fase de Safári Intenso. Para explorar bem Satara (o coração dos leões), o Mdluli ficaria impraticável de longe. O SleepOver entrega exatamente o que é preciso: cama excelente, chuveiro potente e proximidade do parque (ZAR 700 / ~R$ 220).
*   **19:00:** Jantar relaxado no modo DIY (faça você mesmo) com um "Braai" (churrasco local) ou com lanches comprados.

### **18/03 (Quarta): Foco 100% nos Felinos**
*   **05:30:** Café rápido (compre *rusks* sul-africanos no supermercado e coma com café no quarto).
*   **06:00:** Abertura do Orpen Gate. (Lembre-se da taxa de conservação diária do parque).
*   **06:30 - 10:30:** Rota **S100** de fora a fora. É uma estradinha de terra que corre paralela ao rio N'wanetsi. Famosíssima por *prides* (alcateias) inteiras de leões descansando sob a sombra ou atravessando a pista. Se há um lugar no Kruger para apostar 100%, é aqui.
*   **11:00:** Parada (Banheiro/Lanche/Café da manhã reforçado) no Satara Rest Camp.
*   **13:00 - 16:30:** Explorar a represa de Girivana ou percorrer um trecho da Rota H1-4.
*   **17:00:** Retorno ao SleepOver Orpen antes do fechamento dos portões. Repetir churrasco ou jantar leve.

### **19/03 (Quinta): Para a Próxima Etapa**
*   **08:00:** Check-out do SleepOver. 
*   **08:30:** Iniciaremos o longo trajeto em direção ao *Final Leg* (Seja Joanesburgo/Eswatini ou Rota Jardim a confirmar nas próximas pesquisas). O Aeroporto de Nelspruit/Kruger Mpumalanga (MQP) ou Eastgate em Hoedspruit ficam próximos dependendo do voo reservado.

---

## 🇸🇿 LEG 3: ESWATINI (19 - 21 Mar) - O Reino nas Montanhas

### **Por que Eswatini? (A Alma do Roteiro)**
Você perguntou: *"Por que estamos indo lá?"*
Não é só um carimbo no passaporte. Eswatini (antiga Suazilândia) quebra a monotonia da estrada entre Kruger e a praia.
*   **A Paisagem:** Você sai da savana plana e entra em vales verdes de montanhas altíssimas. É a "Suíça da África".
*   **A Cultura:** É um dos últimos reinos absolutistas do mundo. O artesanato aqui (vidro e velas) é o melhor da África Austral.
*   **A Vibe:** O ritmo desacelera. É seguro, rural e extremamente acolhedor.

---

### **Logística Detalhada (Tempos de Estrada)**
*   **Kruger (Orpen) -> Fronteira (Jeppe's Reef):** 3h 15min. (Estradas R40/R570).
*   **Fronteira -> Ezulwini Valley (Hospedagem):** 1h 45min. (Via Piggs Peak - estrada cênica nas montanhas).
*   **Ezulwini -> St Lucia (Saída):** 4h 20min. (Via Golela Border).
*   *Resumo:* É uma parada estratégica perfeita para não fazer uma viagem de 10 horas direto do Kruger para o litoral.

---

### **3 Opções de Hospedagem (Para todos os estilos)**
...
### **Roteiro Otimizado: 19 a 21 de Março**

#### **19/03 (Quinta): Entering The Kingdom**
*   **08:00:** Saída de Orpen/Kruger.
...
*   **Jantar:** No próprio hotel (todos os 3 têm cozinhas excelentes).

#### **20/03 (Sexta): Cultura & Relax (Dia de Rei)**
*   **Manhã:** Visita à **Mantenga Cultural Village** (Show às 11:15) ou **Swazi Candles** (artesanato).
*   **Almoço:** **Malandela's Farm** (ao lado das velas). Comida fresca e ambiente lindo.
*   **Tarde:** Livre para curtir o hotel (Summerfield/Mogi) ou tentar a sorte no **Royal Swazi Spa Casino**.
*   **Hospedagem:** Mesma do dia anterior (Eswatini).

---

## ✈️ LEG 4: O PULO DO GATO (21 Mar)

### **21/03 (Sábado): Eswatini -> JNB -> Garden Route**
*   **Manhã (08:00):** Check-out e estrada direto para JNB.
    *   *Rota:* Via **Oshoek Border Post** (N17). É a fronteira principal, mais rápida para JNB.
    *   *Tempo:* ~3h 30min a 4h (350km). Estrada boa e duplicada na maior parte.
*   **12:30:** Chegada em JNB (OR Tambo). Devolução do Carro 1.
*   **🥂 Sala VIP JNB (Doméstica):** Use a **Bidvest Premier Lounge** (Terminal B). Tem comida quente e bebidas.
*   **Voo Confirmado (Booking #40-890691509):**
### **21/03 (Sábado): Eswatini -> JNB -> Garden Route**
*   **11:25:** Voo JNB -> PLZ (SA 405).
...
*   **21/03: Retirada Carro 2 - [Sixt](https://www.sixt.com/) (Garden Route)**
    ...
    *   **💎 Dica de Ouro (Status Match):** 
        ...
        *   **Benefícios:** Até 15% desc., **Upgrade de categoria grátis** (sujeito a disponibilidade) e fila prioritária no balcão. Faça **online** antes de viajar!
...
*   **Jantar em Port Elizabeth (Summerstrand):**
    1.  **Ginger The Restaurant:** [Site & Menu](https://ginger-restaurant.co.za/). Fica no The Beach Hotel.
        *   *Vibe:* O melhor "Fine Dining" da cidade, de frente para o mar.
        *   *O que pedir:* **Salt and Pepper Squid** (Lula) de entrada e **Linefish of the Day** (Peixe do dia).
    2.  **De Kelder:** [Info](https://dekelder.net/).
        *   *Vibe:* Mais tradicional, focado em vinhos e carnes. Ótimo se quiser um bife suculento.

---

## 🌊 LEG 5: GARDEN ROUTE (22 - 25 Mar)
...
### **24/03 (Terça): Knysna & Ostras**
*   **Bate-volta:** Visita a **Knysna Heads** (Mirante) e Thesen Island.
*   **Almoço:** Ostras frescas no 34 South ou Tapas no **The Fat Fish**.
*   **Tarde:** Pôr do sol no **Emily Moon** (Rio Bitou) - Lugar lindo, dica de insider.

---

## 🐳 LEG 6: HERMANUS & CAPE TOWN (25 - 30 Mar)
...
### **26/03 (Quinta): Baleias & R44**
*   **Manhã:** Caminhada no **Cliff Path** (Hermanus).
*   **Almoço:** **Creation Wines** (Hemel-en-Aarde).
    *   *Carol:* "Melhor vinho da viagem". Reserve o Food Pairing.
*   **Tarde:** Estrada **Clarence Drive (R44)** rumo a Cape Town.
    *   *Atenção:* Não pegue a N2/túnel. Vá pela costa (R44), é considerada uma das 10 estradas mais lindas do mundo.
    *   **Parada VIP:** Vocês passarão de carro por **Strand**. É onde a Dani mora ("cidadezinha na beira do mar"). Se o tempo estiver bom, parem para tomar um café com ela!
...
*   **Opção:** Elena deve estar na cidade. Jantar no **Willoughby & Co** (Sushi no Waterfront, fila anda rápido).

### **28/03 (Sábado): Península do Cabo**
*   **Elena:** "O dia mais bonito da viagem".
*   **Rota:** Camps Bay -> Chapman's Peak Drive (Pedágio) -> Noordhoek -> Cape Point (Farol) -> Cabo da Boa Esperança -> Boulders Beach (Pinguins) -> Simon's Town.
*   **Almoço tardio:** Harbour House (Kalk Bay).

### **29/03 (Domingo): Dia Livre / Elena**
*   **Manhã:** Oranjezicht City Farm Market (Feira gastronômica chique, só sábado/domingo). Imperdível!
*   **Tarde:** Praia de Camps Bay ou Clifton 4th.
*   **Jantar:** **The Pot Luck Club** (Old Biscuit Mill). Reserva obrigatória (abre 3 meses antes). Vista 360º.

---

## 🍷 LEG 7: WINELANDS (30 Mar - 01 Abr)
...
*   **Alternativa Carro (Roteiro Carol):**
    ...
    2.  **Delaire Graff:** "O auge do chique", vista surreal. Vá para um drink no terraço.
    3.  **Kanonkop:** "Intimista, degustação em frente à lareira".
*   **Pôr do Sol:** **Haute Cabrière** (Dica Elena - Espumantes com vista do vale).

---

## 🏙️ LEG 8: THE GRAND FINALE (01 - 03 Abr)

### **01/04 (Quarta): The Last Sunset**
*   **Manhã/Tarde:** Dia livre em Cape Town ou Winelands. Aproveite até o último minuto.
*   **18:30:** Devolução do Carro 2 no Aeroporto de Cape Town (CPT).
*   **🥂 Sala VIP CPT:** Bidvest Premier Lounge (Doméstica). Jantar leve antes do voo.
*   **Voo Confirmado (Booking #40-891067240):**
...
### **03/04 (Sexta): Hamba Kahle (Adeus)**
*   **Manhã:** Café tranquilo.
*   **11:30:** Chegar no Aeroporto JNB.
    *   **🥂 Sala VIP JNB (Internacional):** Terminal A. Vá na **Bidvest Premier Lounge** (Mezanino) ou **Aspire Lounge**. Ótimo para tomar um banho antes do voo longo.
*   **14:50:** Voo JNB -> GRU (LA8059).
*   **20:25:** Chegada em GRU.
    *   **🥂 Sala VIP GRU (Conexão):** Você chega no T3 mas conecta no T2 (Nacional). Despache a mala e vá para a **Plaza Premium Lounge** (T2, depois do raio-x). É a melhor do doméstico.
*   **00:35 (Dia 04/04):** GRU -> BSB (LA4703).

---
**Checklist de Ação Imediata (O Que Fazer Agora):**

### **1. 🚗 Carros & Logística de Estrada**
*   **Carro 1 (JNB): GreenMotion**
    *   **Status:** Reservado via Rentcars (£133.78 - Voucher KF85JS8).
    *   **⚠️ Análise do Especialista:** GreenMotion é *Low-Cost* e opera via **Meet & Greet** (Não tem balcão, o agente te encontra no desembarque). 
    *   **Fronteira Eswatini:** A carta custa aprox. **R1.800**. Informe a agência com 72h de antecedência.
    *   **Vale Trocar?** Se o foco for **Eficiência (Pilar 2)**, trocar pela **Woodford** ou **Avis** (dentro do terminal) evita o stress do shuttle e a burocracia rígida da devolução da GreenMotion. A diferença de custo na carta é irrelevante.
*   **Carro 2 (PLZ): Sixt**
    *   *Retirada:* 21/03 às 14:30 (PLZ - Prédio anexo).
